...
# Generate binned source data and a plot for Supplementary Figure 1b (MHU-2).
#
# Input:
...
input_file <- "SupplementaryData11.txt"
source_data_file <- "SourceData_SuppFig1b.csv"
